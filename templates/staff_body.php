<!DOCTYPE html>
<html lang="es">
<?php $page_title = 'Gesti�n de Staff'; ?>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="staffNav">
                <div class="d-flex gap-2 flex-wrap justify-content-end">
                    ...
                    <a href="configuracion.php" class="btn btn-sm btn-light btn-icon"><iconify-icon icon="mdi:cog" width="16"></iconify-icon> Configuraci�n</a>
