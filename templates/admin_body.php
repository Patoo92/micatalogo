...
<body class="bg-admin sidebar-open <?php echo htmlspecialchars($tema_admin !== 'default' ? 'theme-' . $tema_admin : ''); ?>">
    ...
    <div class="container mt-3" style="max-width: 900px;">
        <div class="row g-2 mb-4">
            <div class="col-12">
                <a href="dashboard.php" class="btn btn-outline-light btn-icon w-100 py-2" style="font-weight:600;border-style:dashed;">
                    <iconify-icon icon="mdi:chart-bar" width="20"></iconify-icon> Ver Dashboard completo con gráficos
                </a>
            </div>
        </div>
        <div class="row g-2 mb-4">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="adminNav">
            <div class="d-flex gap-2 flex-wrap justify-content-end">
                <a href="dashboard.php" class="btn btn-sm btn-light btn-icon"><iconify-icon icon="mdi:chart-bar" width="16"></iconify-icon> Dashboard</a>
